...
WHERE tsp.SYLLABUSELEMENT_ID NOT IN (SELECT PARENT_ID FROM TENJIN_SYLLABUSELEMENT ts2 where ts2.TEMPLATESTRUCTURE_ID = 2)
AND tsp.TEMPLATESTRUCTURE_ID = 1
AND tsp.SITE_ID IN ('PROJ30415.E2020','MNGT60430.E2020','MNGT50407A.A2020','FINA50200A.A2019','PROJ30415.A2020','MNGT60430.A2019','MNGT50407A.A2019','INTE30000.A2019','OPER80565A.A2019','PROJ30415.A2019','PROJ30415.H2020','FINA50200.H2020','FINA50200.E2020','FINA50200.A2020','MNGT60430.A2020','FINA50200.A2019')
AND tsp.SYLLABUSELEMENT_ID = ts.SYLLABUSELEMENT_ID 
AND ts.SYLLABUS_ID = ts3.SYLLABUS_ID 
AND ts3.DELETED = 0
AND tse.PARENT_ID = tsp.SYLLABUSELEMENT_ID);
