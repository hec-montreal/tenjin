tenjinApp.config(['$translateProvider', function($translateProvider) {
	...
	$translateProvider.translations('en_US', {
		...
		FORM_TITLE: 'Title',
		FORM_CLICKABLE_TEXT: 'Clickable Text',
		FORM_DESCRIPTION: 'Description',
		FORM_IMPORTANT: 'Important',
		FORM_VISIBILITY: 'Visibility limited to students of this course',
		FORM_DATE_DISPLAY_START: 'Availability Start Date',
		FORM_DATE_DISPLAY_END: 'Availability End Date',
		FORM_URL: 'URL',
		FORM_URL_EMBED: 'URL',
		...
		CONTACT_TITLE_PROFESSOR: 'Professor',
		...
		FORM_DISPLAY_INTERVAL: 'Show this element between specific dates',
		...
		BUTTON_CREATE_SYLLABUS: 'Create Personalized Course Outline',
		LINK_SYLLABUS: 'Go',
		...
		MODAL_DESCRIPTION_DELETE_SYLLABUS: 'Delete Course Outline(s) ',
		...
		DELETE_SYLLABUS_OK: 'The following course outline(s) will be deleted',
		DELETE_SYLLABUS_KO: 'The following course outline(s) can\'t be deleted because there are sections assigned to them',
		MANAGEMENT_NO_SECTION: 'No section',
		MANAGEMENT_ERROR_NAME: 'The title must be specified',
		FORUM: 'Forum',
		...
		AVAILABLE_TOOL: 'Available Tools',
		...
		FORM_TITLE: 'Titre',
		FORM_CLICKABLE_TEXT: 'Texte cliquable',
		...
		ERROR_TITLE_MANDATORY: 'Le champ titre est obligatoire',
		ERROR_TITLE_TOO_LONG: 'Le champ titre est trop long',
		...
		ALERT_CREATE_ANNOUNCEMENT_SUCCESS: 'L\'annonce a été créé avec succès',
		...
		MANAGEMENT_ERROR_NAME: 'Le titre doit être indiqué',
		FORUM: 'Forum',
		...
		AVAILABLE_TOOL: 'Outils disponibles',
