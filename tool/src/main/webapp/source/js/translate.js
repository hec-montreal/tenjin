tenjinApp.config(['$translateProvider', function($translateProvider) {
	...
	$translateProvider.translations('en', {
		...
		ALERT_IMPORT_SYLLABUS_PERMISSION_ERROR: 'You are not authorized to copy the specified syllabus',
		ALERT_IMPORT_SYLLABUS_NOT_FOUND: 'The specified syllabus does not exist',
		ALERT_IMPORT_SYLLABUS_ERROR: 'An error occured importing the syllabus',
		...
		FORM_IMPORT_INSTRUCTIONS: 'Enter a site id you would like to import the syllabus from. Resources that appear in the syllabus will be automatically copied. Note: This will replace the existing common syllabus!',
		...
		ALERT_IMPORT_SYLLABUS_PERMISSION_ERROR: 'Vous n\'avez pas la permission de copier le plan de cours spécifié',
