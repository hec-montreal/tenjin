tenjinApp.config(['$translateProvider', function($translateProvider) {
	...
	$translateProvider.translations('en_US', {
		...
		FORM_IMPORT_INSTRUCTIONS: 'This tool serves to import a course outline from the former course outline tool (proir to fall 2017). Enter the site id you would like to import the course outline from. All resources in the original course outline will be copied to this site automatically.',
