...
<head>
	...
	<link rel="stylesheet" href="/opensyllabus2-tool/lib/css/bootstrap.css"/>

	<link rel="stylesheet" href="/opensyllabus2-tool/css/opensyllabus.css"/>  
	<link rel="stylesheet" href="/opensyllabus2-tool/lib/css/angular-ui-tree.min.css">   
...
<!-- 	<script src="/opensyllabus2-tool/lib/angular-ui/ui-bootstrap-custom-tpls-1.1.0.js"></script>
 ...
 -->
	...
	<!-- SCRIPTS LANGAGE -->
	<!-- <script src="/opensyllabus2-tool/node_modules/angular-i18n/angular-locale_fr-fr.js"></script> -->

	<!-- SCRIPTS ALL LIBRAIRIES CONCAT -->
	<script src="/opensyllabus2-tool/lib/syllabuslib.js"></script> 
