tenjinApp.controller('ContentPanelCtrl', ['$scope', '$timeout', 'TreeService', 'UserService', 'SyllabusService', 'TenjinService', 'config', '$translate', function($scope, $timeout, TreeService, UserService, SyllabusService, TenjinService, config, $translate) {
	'use strict';
